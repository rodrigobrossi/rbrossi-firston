...
export default function Login() {
  ...
  async function handleDevLogin(e) {
    ...
    try {
      ...
      setErr(e.response?.data?.error || 'Erro ao fazer login')
    ...
    <div style={{
      ...
      <div style={{ width:'100%', maxWidth:400, padding:'0 24px' }}>
        <div className="fade-up" style={{ textAlign:'center', marginBottom:40 }}>
          ...
          <p style={{ color:'var(--text-2)', marginTop:6, fontSize:'.9rem' }}>Bem-vindo de volta</p>
        </div>
        ...
        <div className="card fade-up-2" style={{ padding:28 }}>
          ...
          <form onSubmit={handleDevLogin} style={{ display:'flex', flexDirection:'column', gap:12 }}>
            ...
            <button type="submit" className="btn btn-primary"
              ...
              <Mail size={15} />
              {loading ? 'Entrando…' : 'Entrar com e-mail (dev)'}
            </button>
          </form>
        </div>
